...
export const DefaultPageLayout = ({
  ...
  return (
    <main
      className={cn(
        "w-full h-full  bg-black-light z-40 selection:bg-yellow selection:text-black overflow-y-scroll lg:overflow-hidden relative page-animation animate-fadeIn",
        className,
      )}
